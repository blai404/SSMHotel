...
<body>
		...
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					...
					<!-- style="cursor:pointer"鼠标停留时光标变小手 -->
					<img id="cpacha-image" title="点击切换验证码" style="cursor: pointer;"
						src="get_cpacha?vl=4&w=120&h=40&type=loginCpacha" width="100px"
	...
	function changeCpacha(){
		$("#cpacha-image").attr("src","get_cpacha?vl=4&w=150&h=40&type=loginCpacha" + new Date().getTime())
	}
