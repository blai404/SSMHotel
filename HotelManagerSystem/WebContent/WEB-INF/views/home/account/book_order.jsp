	...
	<div id="section">
		...
		<div class="hotel_inf_w">
			<div class="hotel_roominfobox">
				...
				<ul class="hotel_detail">
					...
					<li><span>可住:</span>${roomType.liveNum }</li>
				...
				<ul>
					...
					<li>
						...
						<div class="info_group">
							<label>入住时间</label>
							<input type="text" name="arriveDate" id="arrivedDate" class="datepicker" /> 
							<label>离店时间</label>
							<input type="text" name="leaveDate" id="leaveDate" class="datepicker" />
						</div>
					...
					<li>
						...
						<div class="info_group">
							<label>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</label>
							<input type="text" name="name" id="name" value="${customer.name }" /><span class="msg"></span>
						</div>
						<div class="info_group">
							<label>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话</label>
							<input type="text" maxlength="11" name="phoneNum" id="phoneNum" value="${customer.phoneNum }" /><span class="msg"></span>
						</div>
						<div class="info_group">
							<label>身份证号</label>
							<input type="text" name="idCard" id="idCard" value="${customer.idCard }" /><span class="msg"></span>
						</div>
						<div class="info_group">
					...
					<li>
						<div class="msg">预定须知:请携带好本人的身份证，办理入住手续</div> 
		...
		<div class="malog">
			<div class="message">
				<p class="msgs"></p>
				<p>
					您可以在 <a href="index#order">我的订单</a>查看详情
				</p>
				<p>
					系统会在<span class="num">3</span>秒后跳转会 <a href="../index">菜单列表</a>
				</p>
			</div>
		</div>
	...
	$(function(){
		...
		$("#btn_booking").click(function(){
			...
			$.ajax({
				...
				type:'post',
				dataType:'json',
				data:{roomTypeId:'${roomType.id }',name:name,phoneNum:phoneNum,idCard:idCard,remark:remark,arrivedDate:arrivedDate,leaveDate:leaveDate},
