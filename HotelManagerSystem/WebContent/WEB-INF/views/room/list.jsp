...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            ...
            <label>所属楼层：</label>
            <select id="search-floor" class="easyui-combobox" panelHeight="auto" style="width:100px">
            	<option value="-1">全部</option>
...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
        	...
        	<tr>
                <td align="right">房型编号:</td>
                <td><input type="text" id="add-sn" name="sn" class="wu-text easyui-validatebox" data-options="required:true,missingMessage:'请填写房型编号'" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign="top" align="right">房间备注:</td>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">房型编号:</td>
                <td><input type="text" id="edit-sn" name="sn" class="wu-text easyui-validatebox" data-options="required:true,missingMessage:'请填写房型编号'" /></td>
            </tr>
            <tr>
                <td align="right">房间类型:</td>
                <td>
